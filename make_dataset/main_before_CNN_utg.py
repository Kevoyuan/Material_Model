...
if __name__ == '__main__':
    ...
    P1.P1(2048, sig45_range, sig90_range, sigb_range, r00_range, r45_range, r90_range, rb_range, M_range)
    print('-----Finish P1------')
    ...
    cpus = 8
    solver_path = "C:\LSDYNA\LSDYNA\program\ls-dyna_smp_d_R11_1_0_winx64_ifort160.exe" 
    prepost_path='C:\LSDYNA\LSDYNA\program\lsprepost.exe'
