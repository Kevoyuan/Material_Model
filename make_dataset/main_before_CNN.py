...
if __name__ == '__main__':
    ...
    # P1.P1(3, sig45_range, sig90_range, sigb_range, r00_range, r45_range, r90_range, rb_range, M_range)
    # print('-----Finish P1------')
    ...
    # prepost_path = "C:\Program Files\LSTC\LS-PrePost\lsprepost4.8_x64.exe"
    prepost_path = "C:\LSDYNA\LS-PrePost\lsprepost4.8_x64.exe"
    # cfile_path='..\..\..\..\optional_files\lspostcmd_multi-section_cut_35-11.cfile'
    cfile_path='..\..\..\..\optional_files\lspostcmd_multi-section_cut_55_11.cfile'
    ...
    # P4_other.P4_2(cpus, prepost_path, cfile_path)
    ...
    ref_y_disp_node = "      1767" 
    ref_y_disp_node2 = "      2134"
